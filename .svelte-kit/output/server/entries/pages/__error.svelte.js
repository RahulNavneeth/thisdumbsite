import { c as create_ssr_component, a as add_attribute, e as escape, n as null_to_empty, v as validate_component } from "../../chunks/index-63796eb4.js";
import { faHome } from "@fortawesome/free-solid-svg-icons";
/* empty css                                                      */const parseNumber = parseFloat;
...
const css = {
  code: ".innerCon.svelte-3wc4io{display:flex;flex-direction:column;align-items:center;width:100%;position:absolute;top:40%}h2.svelte-3wc4io{font-family:monospace;padding:10px;width:25%;background-color:rgb(231, 52, 52);border-radius:10px;text-align:center;display:flex;justify-content:center;align-content:center;align-items:center}a.svelte-3wc4io{text-decoration:none;color:black}code.svelte-3wc4io{font-family:monospace;background:pink;padding:10px;border-radius:6px;font-weight:1000;font-size:35px}.container.svelte-3wc4io{display:flex;flex-direction:column;align-items:center;align-content:center;justify-content:center}.innerErr.svelte-3wc4io{padding:10px;background-color:#fff;border-radius:10px}",
  map: null
};
async function load({ status, error, params }) {
  return { props: { status, error, params } };
}
const _error = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="${"container svelte-3wc4io"}"><div class="${"innerCon svelte-3wc4io"}">
		<h2 class="${"svelte-3wc4io"}"><div class="${"innerErr svelte-3wc4io"}">${escape(status)}</div>
			:
			<div class="${"innerErr svelte-3wc4io"}">${escape(error.message)}</div></h2>
		<a href="${"/"}" class="${"svelte-3wc4io"}"><code class="${"svelte-3wc4io"}">${validate_component(Fa, "Fa").$$render($$result, { icon: faHome }, {}, {})} Home</code></a></div>
</div>`;
});
